...
from reportlab.lib.pagesizes import portrait, landscape  # PySN, A4
from reportlab.graphics import renderPDF
from reportlab.lib.units import inch  # PySN
...
class ImageConverter:
    ...
    # def __init__(self, notebook, palette=None):  # PySN
    def __init__(self, notebook, palette=None, mark=False):  # PySN
        self.note = notebook
    ...
    def convert(self, page_number, visibility_overlay=None):
        ...
        if page.is_layer_supported():
            ...
            # converted_img = self._convert_layered_page(page, self.palette, visibility_overlay, highres_grayscale)  # PySN
            converted_img = self._convert_layered_page(page, self.palette, visibility_overlay, highres_grayscale, self.mark)  # PySN
        else:
    ...
    # def _convert_layered_page(self, page, palette=None, visibility_overlay=None, highres_grayscale=False):  # PySN
    def _convert_layered_page(self, page, palette=None, visibility_overlay=None, highres_grayscale=False, mark=False):  # PySN
        ...
        for layer in layers:
            ...
            imgs[layer_name] = img
        return self._flatten_layers(page, imgs, visibility_overlay, mark)  # PySN
        # return self._flatten_layers(page, imgs, visibility_overlay)  # PySN

    # def _flatten_layers(self, page, imgs, visibility_overlay=None):  # PySN
    def _flatten_layers(self, page, imgs, visibility_overlay=None, mark=False):  # PySN
...
class PdfConverter:
    def __init__(self, notebook, palette=None):
        self.note = notebook
        self.palette = palette
        # self.pagesize = A4  # PySN
        self.pagesize = (19.5*inch, 26*inch)  # PySN Was A4, but chose to switch to Ratta's default export
